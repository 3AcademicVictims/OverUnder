    ...
    venues: [
      {
        ...
        sourceUrl: "https://polymarket.com/event/2026-fifa-world-cup-winner",
        polymarketId: "516729",
        mockImpliedProb: 0.22,
        mockRawPrice: "$0.22",
      },
      {
        venue: "Kalshi",
        label: "Kalshi — KXWORLDCUP Spain",
        sourceUrl: "https://kalshi.com/markets/kxworldcup",
        kalshiTicker: "KXWORLDCUP-26-ESP",
        mockImpliedProb: 0.25,
        mockRawPrice: "25¢ (yes mid)",
      },
      {
        venue: "Sportsbook",
    ...
    venues: [
      {
        ...
        sourceUrl: "https://polymarket.com/event/2026-fifa-world-cup-winner",
        polymarketId: "516731",
        mockImpliedProb: 0.20,
        mockRawPrice: "$0.20",
      },
      {
        venue: "Kalshi",
        label: "Kalshi — KXWORLDCUP France",
        sourceUrl: "https://kalshi.com/markets/kxworldcup",
        kalshiTicker: "KXWORLDCUP-26-FRA",
        mockImpliedProb: 0.18,
        mockRawPrice: "18¢ (yes mid)",
      },
      {
        venue: "Sportsbook",
        label: "The Odds API — FIFA World Cup winner (de-vigged)",
    ...
    venues: [
      {
        ...
        sourceUrl: "https://polymarket.com/event/2026-fifa-world-cup-winner",
        polymarketId: "516733",
        mockImpliedProb: 0.14,
        mockRawPrice: "$0.14",
      },
      {
        venue: "Kalshi",
        label: "Kalshi — KXWORLDCUP England",
        sourceUrl: "https://kalshi.com/markets/kxworldcup",
        kalshiTicker: "KXWORLDCUP-26-ENG",
        mockImpliedProb: 0.155,
        mockRawPrice: "15.5¢ (yes mid)",
      },
      {
        venue: "Sportsbook",
        label: "The Odds API — FIFA World Cup winner (de-vigged)",
